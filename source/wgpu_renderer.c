...
void wgpu_renderer_init(struct sf_arena *arena, struct wgpu_renderer *r) {
...

   {
      ...
      wgpuInstanceRequestAdapter(r->instance, &options,
                                 wgpu_renderer_set_adapter, &adapter_handle);
   ...
   wgpuDeviceSetUncapturedErrorCallback(r->device,
                                        wgpu_renderer_unhandled_error, r);
